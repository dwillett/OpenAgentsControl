...
# Configuration
REPO_URL="https://github.com/dwillett/OpenAgentsControl"
BRANCH="${OPENCODE_BRANCH:-main}"  # Allow override via environment variable
RAW_URL="https://raw.githubusercontent.com/dwillett/OpenAgentsControl/${BRANCH}"
...
check_interactive_mode() {
    ...
    if [ ! -t 0 ]; then
        ...
        echo "curl -fsSL https://raw.githubusercontent.com/dwillett/OpenAgentsControl/main/install.sh -o install.sh"
        echo ""
        ...
        echo "curl -fsSL https://raw.githubusercontent.com/dwillett/OpenAgentsControl/main/install.sh | bash -s essential"
        echo ""
    ...
    while [ $# -gt 0 ]; do
        case "$1" in
            ...
            --help|-h|help)
                ...
                echo "  curl -fsSL https://raw.githubusercontent.com/dwillett/OpenAgentsControl/main/install.sh | bash -s developer"
                echo ""
